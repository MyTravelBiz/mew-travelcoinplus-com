...
/* Onboarding */
ONBOARD_welcome_title           :  'Welcome to TravelCoinPlus Wallet',
...
ONBOARD_welcome_content__4      :  'What is TravelCoinPlus Wallet? ',
ONBOARD_welcome_content__5      :  'TravelCoinPlus Wallet is a free, open-source, client-side interface.',
ONBOARD_welcome_content__6      :  'We allow you to interact directly with the TravelCoinPlus blockchain while remaining in full control of your keys &amp; your funds.',
...
ONBOARD_bank_title              :  'TravelCoinPlus Wallet is not a Bank',
...
ONBOARD_interface_title         :  'TravelCoinPlus Wallet is an Interface',
ONBOARD_interface_content__1    :  'When you create an account on TravelCoinPlus Wallet you are generating a cryptographic set of numbers: your private key and your public key (address).',
...
ONBOARD_interface_content__5    :  'You are simply using our **interface** to interact **directly with the TravelCoinPlus blockchain**.',
ONBOARD_interface_content__6    :  'If you send your *public key (address)* to someone, they can send you TLCP or tokens. 👍',
ONBOARD_interface_content__7    :  'If you send your *private key* to someone, they now have full control of your account. 👎',
ONBOARD_bank_title__alt         :  'TravelCoinPlus Wallet isn\'t a Bank',
...
ONBOARD_blockchain_content__1   :  'The TravelCoinPlus blockchain is like a huge, global, decentralized spreadsheet.',
ONBOARD_blockchain_content__2   :  'It keeps track of who sent how many coins to whom, and what the balance of every account is.',
ONBOARD_blockchain_content__3   :  'It is stored and maintained by people across the globe who have special computers.',
ONBOARD_blockchain_content__4   :  'The blocks in the TravelCoinPlus blockchain are made up of all the individual transactions sent from TravelCoinPlus Wallet, MetaMask, and everywhere else.',
ONBOARD_blockchain_content__5   :  'When you see your balance on TravelCoinPlus Wallet or view your transactions on [ethplorer.travelcoinplus.com](https://ethplorer.travelcoinplus.com), you are seeing data on the TravelCoinPlus blockchain, not in our personal systems.',
ONBOARD_blockchain_content__6   :  'Again: **we are not a bank**.',
ONBOARD_interface_title__alt    :  'TravelCoinPlus Wallet is an Interface',
...
ONBOARD_blockchain_title__alt   :  'What is a Blockchain?',
ONBOARD_point_title__alt        :  'What\'s the Point of TravelCoinPlus Wallet then?',
ONBOARD_whymew_title            :  'If TravelCoinPlus Wallet can\'t do those things, what\'s the point?',
ONBOARD_whymew_content__1       :  'Because that is the point of decentralization and the TravelCoinPlus blockchain.',
...
ONBOARD_whymew_content__4       :  'If you don\'t find these things valuable, ask yourself why you think the TravelCoinPlus blockchain and cryptocurrencies are valuable. 😉',
ONBOARD_whymew_content__5       :  'If you don\'t like the sound of this, consider using an exchange. They have more familiar accounts with usernames & passwords.',
...
ONBOARD_secure_1_content__1     :  'Phishers send you a message with a link to a website that looks just like TravelCoinPlus Wallet, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.',
ONBOARD_secure_1_content__2     :  'Install [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) or [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn).',
ONBOARD_secure_1_content__3     :  'Always check the URL: `https://mew.travelcoinplus.com`.',
ONBOARD_secure_1_content__4     :  'Always make sure the URL bar has `TravelCoinPlus.com` in it.',
...
ONBOARD_secure_3_title__alt     :  'Beat Phishers',
...
ONBOARD_final_content__9        :  'OMG, please just let me send TLCP .',
