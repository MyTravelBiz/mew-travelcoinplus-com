      ...
      <div class="modal-body">
        ...
        <article class="onboarding__modal" ng-show="showOnboardSlide==1">
          <h3 class="onboarding__title">
            <span translate="ONBOARD_welcome_title">
              Welcome to the TravelCoinPlus Web Wallet
            </span>
            <br />
          ...
          <section class="row row--flex">
            <div class="col-xs-12 col-sm-7 onboarding__content">
              ...
              <h5 translate="ONBOARD_welcome_content__4">
                What is mew.travelcoinplus.com?
              </h5>
              <ul>
                <li translate="ONBOARD_welcome_content__5">
                  mew.travelcoinplus.com is a free, open-source, client-side interface to the TravelCoinPlus blockchain.
                </li>
                <li translate="ONBOARD_welcome_content__6">
                  We allow you to interact directly with the TravelCoinPlus blockchain while remaining in full control of your keys &amp; your funds.
                </li>
          ...
          <div class="onboarding__buttons text-center">
            <a ng-click="setOnboardStatus(2)" class="btn btn-primary">
              <span translate="ONBOARD_bank_title">
                mew.TravelCoinPlus.com is not a Bank
              </span>
            </a>
          </div>
        </article>
          ...
          <div class="onboarding__buttons">
            ...
            <a ng-click="setOnboardStatus(3)" class="btn btn-primary">
              <span translate="ONBOARD_interface_title">
                mew.travelcoinplus.com is an Interface
              </span>
            </a>
          </div>
        </article>
            ...
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_interface_content__5">
                  You are just using our **interface** to interact **directly with the TravelCoinPlus blockchain**.
                </li>
                <li translate="ONBOARD_interface_content__6">
                  If you send your *public key (address)* to someone, they can send you TLCP. 👍
                </li>
          ...
          <div class="onboarding__buttons">
            <a ng-click="setOnboardStatus(2)" class="btn btn-default">
              <span translate="ONBOARD_bank_title__alt">
                mew.TravelCoinPlus.com isn't a Bank
              </span>
            </a>
            ...
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_blockchain_content__3">
                  It is stored and maintained by people across the globe who have special computers.
                </li>
                <li translate="ONBOARD_blockchain_content__4">
                  It is made up of all the individual transactions sent from mew.travelcoinplus.com, and everywhere else.
                </li>
                <li translate="ONBOARD_blockchain_content__5">
                  When you see your balance on mew.travelcoinplus.com or view your transactions on [ethplorer.travelcoinplus.com](https://ethplorer.travelcoinplus.com), you are seeing data on the blockchain, not in our personal systems.
                </li>
          ...
          <div class="onboarding__buttons">
            ...
            <a ng-click="setOnboardStatus(6)" class="btn btn-primary">
              <span translate="ONBOARD_point_title__alt">
                What's the Point of mew.travelcoinplus.com then?
              </span>
            </a>
          </div>
        </article>
        ...
        <article class="onboarding__modal" ng-show="showOnboardSlide==6">
          <h3 class="onboarding__title" translate="ONBOARD_whymew_title">
            If mew.travelcoinplus.com can't do those things, what's the point?
          </h3>
          <section class="row row--flex">
            <div class="col-xs-12 col-sm-4 onboarding__image">
        ...
        <article class="onboarding__modal" ng-show="showOnboardSlide==7">
          ...
          <p translate="ONBOARD_secure_1_content__1">
            Phishers send you a message with a link to a website that looks just like mew.travelcoinplus.com, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.
          </p>
          <section class="row row--flex">
            <div class="col-xs-12 col-sm-8 onboarding__content">
              <ul>
                ...
                <li translate="ONBOARD_secure_1_content__3">
                  Always check the URL: `https://mew.travelcoinplus.com`.
                </li>
                <li translate="ONBOARD_secure_1_content__4">
                  Always make sure the URL bar has `TravelCoinPlus.com` in the address.
                </li>
                ...
                <li>
                  <a ng-click="onboardModal.close();globalService.currentTab=globalService.tabs.sendTransaction.id"
                     ...
                     <span translate="ONBOARD_final_content__9">
                       OMG, please just let me send TravelCoinPlus.
                     </span>
                  </a>
                </li>
              </ul>
